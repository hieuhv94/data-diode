...
CONFIG_CLEAN_FILES = rust/derive/Cargo.toml rust/.cargo/config \
	suricata.yaml python/suricata/config/defaults.py \
	libsuricata-config
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	$(srcdir)/libsuricata-config.in $(srcdir)/suricata.yaml.in \
	$(top_srcdir)/python/suricata/config/defaults.py.in \
	$(top_srcdir)/rust/.cargo/config.in \
	$(top_srcdir)/rust/derive/Cargo.toml.in COPYING ChangeLog \
	README.md compile config.guess config.rpath config.sub \
...
ACLOCAL = ${SHELL} '/home/suri/workspaces/suricata-7.0.1/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} '/home/suri/workspaces/suricata-7.0.1/missing' autoconf
AUTOHEADER = ${SHELL} '/home/suri/workspaces/suricata-7.0.1/missing' autoheader
AUTOMAKE = ${SHELL} '/home/suri/workspaces/suricata-7.0.1/missing' automake-1.16
AWK = gawk
CARGO = /usr/bin/cargo
CARGO_BUILD_TARGET = 
CARGO_HOME = /home/suri/.cargo
CBINDGEN = no
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2 -fPIC -std=c11 -march=native -include rte_config.h -march=native -I/usr/local/include -I${srcdir}/../rust/gen -I${srcdir}/../rust/dist
CLANG = 
CLANG_CFLAGS = 
...
CPP = gcc -E
CPPFLAGS = -I${srcdir}/../libhtp/   -D__SCFILENAME__=\"$(*F)\"
CSCOPE = cscope
CTAGS = ctags
CXX = g++
CXXCPP = g++ -E
...
LUA_LIBS = 
MAJOR_MINOR = 7.0
MAKEINFO = ${SHELL} '/home/suri/workspaces/suricata-7.0.1/missing' makeinfo
MANIFEST_TOOL = :
...
RUST_SURICATA_LIB = ../rust/target/release/libsuricata_rust.a
RUST_SURICATA_LIBDIR = ../rust/target/release
...
VERSION = 7.0.1
abs_builddir = /home/suri/workspaces/suricata-7.0.1
abs_srcdir = /home/suri/workspaces/suricata-7.0.1
abs_top_builddir = /home/suri/workspaces/suricata-7.0.1
abs_top_srcdir = /home/suri/workspaces/suricata-7.0.1
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
dvidir = ${docdir}
e_datadir = /usr/local/var/lib/suricata/data
e_datarulesdir = /usr/local/share/suricata/rules
e_defaultruledir = /usr/local/var/lib/suricata/rules
e_enable_evelog = yes
...
e_rustdir = /home/suri/workspaces/suricata-7.0.1/rust
...
install_sh = ${SHELL} /home/suri/workspaces/suricata-7.0.1/install-sh
...
$(am__aclocal_m4_deps):
rust/derive/Cargo.toml: $(top_builddir)/config.status $(top_srcdir)/rust/derive/Cargo.toml.in
...
python/suricata/config/defaults.py: $(top_builddir)/config.status $(top_srcdir)/python/suricata/config/defaults.py.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
libsuricata-config: $(top_builddir)/config.status $(srcdir)/libsuricata-config.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
