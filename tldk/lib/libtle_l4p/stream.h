...
stream_get_dest(struct tle_stream *s, const void *dst_addr, const void *src_addr,
	struct tle_dest *dst)
{
	int32_t rc;
	const struct in_addr *d4, *s4;
	const struct in6_addr *d6, *s6;
	struct tle_ctx *ctx;
	struct tle_dev *dev;
