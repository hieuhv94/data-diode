...
main(int argc, char *argv[])
{
	...
	printf("prt_num %u\n", becfg.prt_num);
	printf("cpu_num %u\n", becfg.cpu_num);
	printf("mpool_buf_num %u\n", becfg.mpool_buf_num);
	printf("prt %p\n", becfg.prt);
	printf("cpu %p\n", becfg.cpu);

	printf("ctx_prm.proto = %u;\n", ctx_prm.proto);
	printf("ctx_prm.max_streams = %u;\n", ctx_prm.max_streams);
	printf("ctx_prm.max_stream_rbufs = %u;\n", ctx_prm.max_stream_rbufs);
	printf("ctx_prm.max_stream_sbufs = %u;\n", ctx_prm.max_stream_sbufs);
	printf("ctx_prm.send_bulk_size = %u;\n", ctx_prm.send_bulk_size);
	printf("ctx_prm.flags = %u;\n", ctx_prm.flags);
	printf("ctx_prm.icw = %u;\n", ctx_prm.icw);
	printf("ctx_prm.timewait = %u;\n", ctx_prm.timewait);
	printf("ctx_prm.hash_alg = %u;\n", ctx_prm.hash_alg);
